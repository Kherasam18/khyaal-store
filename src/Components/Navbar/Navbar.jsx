  ...
  return (
    <>
      <div className="flex justify-around items-center">
        <div>
          {/* <img className="h-28 w-full" alt="Khyaal store"></img> */}
          <p className=" font-inter text-base font-large tracking-normal leading-none text-center mr-2">Khyaal Store</p>
        </div>
